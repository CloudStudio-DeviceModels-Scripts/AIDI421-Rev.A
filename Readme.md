...
# Parsing + Configuration Script – AIDI421 - Rev. A

This **Parsing + Configuration** script is designed for the **AIDI421** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AIDI421 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AIDI421** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
